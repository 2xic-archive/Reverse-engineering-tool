...
'''
print(get_negative_val(0xffffffffffffffe0))

print(get_negative_val(0xffffffffffffffd8))

print(get_negative_val(0xfffffffffffffff0))

print(get_negative_val(0xffffffffffffffe8))
